...
* **최종 갱신일**: 2026-08-17
* **문서 버전**: v3.1 (DEV03: TASK-DEV-09 완료)
...
| **현재 버전** | v1.2.3 (Phase 1~5 및 v1.1 정비 완료, TASK-DEV-07·08·09 완료) |
| **테스트** | Vitest 14개 파일 / **81개 케이스 전부 PASS** |
| **타입 검사** | `npx tsc --noEmit` — 0 Errors |
| **git 상태** | `main` 브랜치, DEV03 재발주 작업(TASK-DEV-09) 완료 (v3.1) |
| **현재 오픈 업무** | `5.3 업무 배분표` 참조 (QA03: TASK-QA-04) |
...
* **업무 내용**:
  ...
  - [ ] 전체 81개 Vitest + `tsc` + 빌드 무결성 확인 및 대시보드 갱신.
...
| v1.2 사용자 피드백 대응 | AI 힌트 맴돔 수정, 애니메이션 속도 통일, 타이틀 카드 배경 통일, 서브패스 배포 | 🔄 진행 중 (TASK-DEV-07·08·09 완료 → QA03: TASK-QA-04 검증 대기) |
...
| :--- | :--- | :--- | :---: | :--- |
| FB-01 | AI 힌트 4x4/5x5 맴돔 및 시각적 진동 | 4x4 Weighted A* ($w=2$) 비허용 휴리스틱 지역 루프 + scale 바운스 떨림 | **TASK-DEV-09** | [x] 완료 2026-08-17 (DEV03 - TASK-DEV-09) |
