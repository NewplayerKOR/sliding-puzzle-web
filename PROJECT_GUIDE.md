...
| :--- | :---: | :--- | :--- | :---: | :--- | :---: |
| **DEV01** | DEV | CSS 하드코딩 절대 경로 5건을 상대 경로로 수정 (BUG-06 잔여) | `src/styles/index.css` L133·162·178, `src/components/Board/Tile.css` L36, `src/components/Modal/WinModal.css` L119 | 없음 | npm test 71 PASS / tsc 0 에러 / build 정상 / 대시보드 갱신 | [ ] |
...
| v1.1 정비 | BUG-06 잔여·PROD 게이팅 수정 및 회귀 검증 | 🔄 진행 중 (DEV01·02 → QA01·02) |
...
| BUG-06 | 하드코딩 절대 경로 | P2 | 🔶 **CSS 5건 잔여** | **DEV01** |
